...
class ProductFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'product_ibfk_1' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organization', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'created_at' => '2018-07-15 11:19:10',
                'last_updated' => '2018-07-15 11:19:10'
            ],
        ];
        parent::init();
    }
