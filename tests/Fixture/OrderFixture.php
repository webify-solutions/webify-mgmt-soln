...
class OrderFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'total_discount' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'order_ibfk_1' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customer', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
            'order_ibfk_2' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organization', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'total_discount' => 1,
                'active' => 1,
                'created_at' => '2018-07-15 11:19:24',
                'last_updated' => '2018-07-15 11:19:24'
            ],
        ];
        parent::init();
    }
