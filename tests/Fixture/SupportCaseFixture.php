 ...
 *
 */
class SupportCaseFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'customer_number' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'support_case_ibfk_1' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customer', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
            'support_case_ibfk_2' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organization', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => '2018-07-15 11:19:01',
                'last_updated' => '2018-07-15 11:19:01'
            ],
        ];
        parent::init();
    }
