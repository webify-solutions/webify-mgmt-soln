...
class CustomerFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK1' => ['type' => 'index', 'columns' => ['group_id'], 'length' => []],
            'FK2' => ['type' => 'index', 'columns' => ['organization_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'customer_ibfk_1' => ['type' => 'foreign', 'columns' => ['group_id'], 'references' => ['group', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
            'customer_ibfk_2' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organization', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'latitude' => 1,
                'active' => 1,
                'created_at' => '2018-07-15 11:18:53',
                'last_updated' => '2018-07-15 11:18:53'
            ],
        ];
        parent::init();
    }
