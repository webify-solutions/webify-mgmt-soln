...
class CustomerFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'org_cust_num' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'customer_number' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'login_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'customer_number_UNIQUE' => ['type' => 'unique', 'columns' => ['organization_id', 'org_cust_num'], 'length' => []],
            'customer_ibfk_1' => ['type' => 'foreign', 'columns' => ['group_id'], 'references' => ['group', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'customer_ibfk_2' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organization', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'latitude' => 1,
                'active' => 1,
                'created_at' => '2018-10-08 20:52:45',
                'last_updated' => '2018-10-08 20:52:45'
            ],
        ];
        parent::init();
    }
