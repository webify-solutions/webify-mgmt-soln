...
class UserFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'login_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'user_ibfk_1' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organization', 'id'], 'update' => 'restrict', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'created_at' => '2018-07-15 11:18:34',
                'last_updated' => '2018-07-15 11:18:34',
                'last_logged_in' => '2018-07-15 11:18:34'
            ],
        ];
        parent::init();
    }
